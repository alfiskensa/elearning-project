<?php
class Detail_kelas_model extends CI_Model{

  var $table = 'peserta_kelas';
	var $column_order = array('nim','nama_mhs','angkatan'); //set column field database for datatable orderable
  ...
  private function _get_datatables_query($data)
    ...
    $this->db->join('mahasiswa', 'peserta_kelas.nim = mahasiswa.nim');
    $this->db->where($data);
