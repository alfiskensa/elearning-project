...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('kelas/kelas_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="matkul"]').val(data.kd_matkul);
            $('[name="dosen"]').val(data.nidn);
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('kelas/kelas_add')?>";
    } else {
        url = "<?php echo site_url('kelas/kelas_update')?>";
    }
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('kelas/kelas_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
...
function peserta_kelas(id) {
	location.href = "<?php echo site_url('detail_kelas?q='); ?>"+id;
}
                            ...
                            <label class="control-label col-md-3">Matakuliah</label>
														<div class="col-md-9">
															<select name="matkul" class="form-control">
																...
																<?php $i=0; foreach($matkul as $row){ $i++; ?>
                            ...
                            <label class="control-label col-md-3">Dosen Pengajar</label>
														<div class="col-md-9">
															<select name="dosen" class="form-control">
																	...
																	<?php $i=0; foreach($dosen as $row){ $i++; ?>
