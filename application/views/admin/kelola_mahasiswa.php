...
function edit_person(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('mahasiswa/mhs_edit')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="angkatan"]').val(data.angatan);
...
function delete_person(id)
{
    if(confirm('Are you sure delete this data?'))
    {
        ...
        $.ajax({
            url : "<?php echo site_url('mahasiswa/mhs_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Nama mhs</label>
                            <div class="col-md-9">
                                <input name="nama_mhs" placeholder="Nama Mahasiswa" class="form-control" type="text">
                                <span class="help-block"></span>
                            </div>
                        </div>
												<div class="form-group">
